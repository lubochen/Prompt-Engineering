...
public enum Model {
    ...
    QWEN_PLUS_LATEST("qwen-plus-latest","能力均衡，推理效果、成本和速度介于通义千问-Max和通义千问-Turbo之间，适合中等复杂任务。","qwen-plus-latest"),
    ...
    DOUBAO_PRO("ep-20241211183223-drfx8","Doubao-pro-32k,是豆包推出行业领先的专业版大模型。模型在参考问答、摘要总结、创作等广泛的应用场景上能提供优质的回答，是同时具备高质量与低成本的极具性价比模型。","Doubao-pro-32k"),
    DOUBAO_LITE("ep-20241211183253-kkskm","Doubao-lite-32k,拥有极致的响应速度，更好的性价比","Doubao-lite-32k");
